export function PageHeader({
  ...
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(120% 130% at 80% 0%, oklch(36% 0.088 220 / 0.35) 0%, transparent 60%), linear-gradient(150deg, oklch(32% 0.085 216) 0%, oklch(26% 0.078 214) 55%, oklch(18% 0.06 210) 100%)",
      }}
    >
